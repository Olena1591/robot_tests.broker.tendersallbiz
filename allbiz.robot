...
Створити план
  ...
  ...  ELSE IF  "${tender_data.data.tender.procurementMethodType}" == "aboveThresholdUA.defens"  Wait And Select From List By Value  name=procurementMethod  open_aboveThresholdUA.defense
